                    ...
                    <form role="form" method="post" action="">
                        <fieldset>
                            <div class="form-group col-lg-6">
                                ...
                                <input class="form-control" required placeholder="<?php echo $Name; ?>"
                                       value="<?php echo $row['Title']; ?> " name="iname" type="text" autofocus>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" required placeholder="<?php echo $Amount; ?>"
                                           value="<?php echo number_format($row['Amount']); ?>" id="iamount"
                                           name="iamount" type="text" value="">
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <select name="icategory" class="form-control">
                                    <option value="<?php echo $row['CategoryId']; ?>"
                                            select="selected"><?php echo $row['CategoryName']; ?></option>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select name="iaccount" class="form-control">
                                    <option value="<?php echo $row['AccountId']; ?>"
                                            select="selected"><?php echo $row['AccountName']; ?></option>
                                    <option value="" disabled>------------------</option>
                            ...
                            <div class="form-group col-lg-6" id="income">
                                ...
                                <div class="input-group date">
                                    <input name="idate" class="form-control" type="text"

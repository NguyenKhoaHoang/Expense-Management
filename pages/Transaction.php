                    ...
                    <form action="" method="post" role="form">
                        <fieldset>
                            <div class="form-group col-lg-6">
                                ...
                                <input class="form-control" required placeholder="<?php echo $Name; ?>" name="ename"
                                       type="text" autofocus>
                            </div>
                    ...
                    <form role="form" method="post" action="">
                        <fieldset>
                            <div class="form-group col-lg-6">
                                ...
                                <input class="form-control" required placeholder="<?php echo $Name; ?>" name="iname"
                                       type="text" autofocus>
                            </div>
                            ...
                            <div class="form-group col-lg-5">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><?php echo $ColUser['Currency']; ?></span>
                                    <input class="form-control" required placeholder="<?php echo $Amount; ?>"
                                           id="iamount" name="iamount" type="text" value="">
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
